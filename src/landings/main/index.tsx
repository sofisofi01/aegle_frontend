    ...
    <Page>
      ...
      <section className={styles.advantagesBlock}>
        ...
        <div className={styles.advHeader}>
          <p className={styles.advSmallTitle}>
            Everything you need to take care of yourself
          </p>
          <h2 className={styles.advBigTitle}>
        ...
        <div className={styles.advCard}>
          ...
          <div className={styles.featuresGrid}>
            <div>
              ...
              <p>
                Log your meals, count calories, and understand your daily intake
                with smart food search.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Visualize your journey through interactive graphs and real-time
                insights.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Get tailored advice on nutrition, motivation, and healthy habits.
              </p>
            </div>
          </div>
          ...
          <div className={styles.steps}>
            <p><b>✦ Set your goals</b><br/>
            Create your profile, define your target weight and activity level.</p>

            <p><b>✦ Track daily habits</b><br/>
            Log meals, workouts, and wellness stats with ease.</p>

            <p><b>✦ See your results</b><br/>
            Watch your progress and celebrate balance every day.</p>
          </div>

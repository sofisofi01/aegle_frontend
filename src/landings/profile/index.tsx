              ...
              {isEditingProfile ? (
                <>
                  <label className={styles.profileField}>
                    ...
                    />
                    {emailError && (
                      <span className={styles.profileError}>{emailError}</span>
                    )}
                  </label>
                  <label className={styles.profileField}>
                    <span>Sex</span>
                ...
                <>
                  ...
                  <p>{profileInfo.sex}, {profileInfo.age} y.o</p>
            ...
            <div className={styles.content}>
              <div className={styles.goalRow}>
                ...
                {isEditingGoals ? (
                  ...
                  <span>
                    <span className={styles.value}>{goalsInfo.dailyCalories}</span>{" "}
                    kcal
                  </span>
                )}
              </div>
              ...
              <div className={styles.goalRow}>
                ...
                {isEditingGoals ? (
                  ...
                  <span>
                    <span className={styles.value}>{goalsInfo.workoutSessions}</span>{" "}
                    sessions/week
                  </span>
                )}
              </div>
              ...
              <div className={styles.goalRow}>
                ...
                {isEditingGoals ? (
                  ...
                  <span>
                    <span className={styles.value}>{goalsInfo.workoutMinutes}</span>{" "}
                    min/week
                  </span>
                )}
              </div>
              ...
              <div className={styles.goalRow}>
                ...
                {isEditingGoals ? (
                  ...
                  <span>
                    <span className={styles.value}>{goalsInfo.stepsPerDay}</span>{" "}
                    steps/day
                  </span>
                )}
              </div>
              ...
              <button
                type="button"
                className={styles.editGoals}
                onClick={handleGoalsEditToggle}
              >
